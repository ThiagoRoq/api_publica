...
class Queries(str, Enum):
    ...
    get_solicitacoes = '''
            ...
            tipo_da_deficiencia_meta, local_de_retirada_meta, municipios_naturalidade_meta, meta, attachments, statusId, channelId, 
    ...
    get_aprovados = '''
            ...
            a.municipios_beneficiario_meta, s.local_de_retirada_meta, a.foto_3x4, a.foto_digital, a.hashId, a.vencimento, a.expedicao, a.lote, a.auditor, a.statusId, 
    ...
    get_consulta_geral = '''
                ...
                tipo_da_deficiencia_meta, local_de_retirada_meta, 
    ...
    get_solicitation_by_hashId = '''
        select alert_id ,benef_cpf ,benef_nome ,benef_rg ,benef_data_nasc ,cid ,fator_rh ,resp_nome ,resp_rg ,benef_telefone, resp_telefone, meta, local_de_retirada_meta, municipios_naturalidade_meta, tipo_da_deficiencia_meta, external_id, created_at, tipo_carteira, statusId, channelId, attachments, resp_email
        from solicitacoes s
        where hashId = %s
