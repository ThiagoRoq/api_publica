...
class HashRequest:
  def __init__(self, benef_cpf, hashId, benef_nome, resp_nome, cid, tipo_da_deficiencia_meta, idade, benef_telefone, local_de_retirada, channelId, alert_id, last_created, last_updated, total):
